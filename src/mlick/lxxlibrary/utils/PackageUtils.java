...
import mlick.lxxlibrary.utils.ShellUtils.CommandResult;
...
public class PackageUtils {
     ...
     * @return
     */
    public static ArrayList<String> getAllAppPackageName(Context context) {
    ...
    public static  String getAppVersion(Context context) {
        ...
        try {
            ...
            // return this.getString(R.string.v)
            Logger.e(TAG, "versionName==================>>>"+version);
        } catch (Exception e) {
